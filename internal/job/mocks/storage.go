...
func (_m *Storage) DeleteByName(name string) error {
	ret := _m.Called(name)
...
func (_m *Storage) GetAll() ([]job.Job, error) {
	ret := _m.Called()
...
func (_m *Storage) GetByName(name string) (*job.Job, error) {
	ret := _m.Called(name)
...
func (_m *Storage) Store(_a0 *job.Job) error {
	ret := _m.Called(_a0)
